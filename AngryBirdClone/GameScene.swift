...
//  AngryBirdClone
//
//  Created by Doğukan Küçükler on 28.07.2023.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
 ...
 //  var bird2 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        bird2.size = CGSize(width: self.frame.width / 16, height: self.frame.height / 9)
        bird2.zPosition = 1
        self.addChild(bird2)
         */
       // physics body
        ...
        bird.physicsBody = SKPhysicsBody(circleOfRadius: birdTexture.size().width / 15)
